...
- **Phase 21 / 选项 B 已交付**：**`docs/166`**；ADR **`docs/165`**（B 已落地，C 未做）。
- Next Unique Priority Action: 生产 **`docs/161`**；客户 **`docs/162`**；staging **`docs/157`**；可选 **Phase 21.2**（autotune → 运行时 JSON 合并写入，需立项）；门禁 **T0+T1** / **`docs/155`**。
