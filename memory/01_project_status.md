...
- Current Version: **Pro_v1.07.25** (package.json: 1.7.25)
...
- Current Completion Point: **Pro_v1.07.25** — **`docs/155`** 增补 *Typical OpenClaw profile*：只读容器正式口径（Git/Docker/CI 由宿主；HEAD 用 `report:agent-git`）；**159** 镜像增强路径照旧
