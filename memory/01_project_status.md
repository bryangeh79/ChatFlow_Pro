...
- Current Completion Point: **Pro_v1.07.20 + Phase 17.1** — Zalo 401 refresh (`docs/154`); 龙虾容器可无 git：用 **`npm run report:agent-git`** 报 SHA（`docs/155`）；完整交付链仍要宿主 git 或镜像内 git
