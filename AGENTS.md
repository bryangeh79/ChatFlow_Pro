...
- Staging Phase B/C env self-check (no secret echo): **`npm run check:staging-env`** — **`docs/160`** §4; optional notify receiver contract — **`docs/161_phase17_notify_webhooks.md`**.  
